...
export default function ReleaseNote0120({
	...
	return (
		<MessageTip
			...
			message={
				<div>
					You are using {release} of Valirya. We have introduced distributed setup in
					v1.12.0 release. If you use or plan to use clickhouse queries in dashboard
					or alerts, you might want to read about querying the new distributed tables{' '}
					<a
						href="https://valirya.net/docs/operate/migration/upgrade-0.12/#querying-distributed-tables"
						target="_blank"
						rel="noreferrer"
					>
						here
